...
for C in [0.00001,0.0001,0.001,0.01,0.1,1,10,100,1000,10000,100000]:
    ...
    clf = SVC(kernel="Sigmoid", gamma= gamma, C = C)
    clf.fit(TrainData, TrainLabel)
    Modalpath = r"/home/axk/sksvm/SVMmodal/svmModel" + str(gamma) + "c" + str(C) + r".plk"
    ...
    prpath = r"/home/axk/sksvm/prpicture/" + str(gamma) + "c" + str(C) + r".png"
    plt.savefig(prpath)
    plt.close()
    ...
    rocpath = r"/home/axk/sksvm/rocpicture/" + str(gamma) + "c" + str(C) + r".png"
    plt.savefig(rocpath)
    plt.close()
    ...
    #储存数据到excel
    wb = openpyxl.load_workbook(r"/home/axk/sksvm/result.xlsx")
    ws = wb.active
    ...
    start += 1
    wb.save(r"/home/axk/sksvm/result.xlsx")
