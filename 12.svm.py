...
temp = TrainNegative
for i in range(9):
    NegativeTrain = np.vstack((NegativeTrain,temp))
NegativeTrainLabel = []
...
for C in [0.001,0.01,0.1,1,10,100]:
    ...
    Modalpath = r"/home/axk/chipsvm/SVMmodal/svmModel" + str(gamma) + "c" + str(C) + r".plk"
    ...
    prpath = r"/home/axk/chipsvm/prpicture/" + str(gamma) + "c" + str(C) + r".png"
    plt.savefig(prpath)
    ...
    rocpath = r"/home/axk/chipsvm/rocpicture/" + str(gamma) + "c" + str(C) + r".png"
    plt.savefig(rocpath)
    ...
    #储存数据到excel
    wb = openpyxl.load_workbook(r"/home/axk/chipsvm/result.xlsx")
    ws = wb.active
    ...
    start += 1
    wb.save(r"/home/axk/chipsvm/result.xlsx")
